...
const Navbar = () => {
  ...
  return (
    ...
    <ul className={` menu ? "block" : "hidden"       mx-24 p-y2 font-semibold md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>
        <a href="#About">
